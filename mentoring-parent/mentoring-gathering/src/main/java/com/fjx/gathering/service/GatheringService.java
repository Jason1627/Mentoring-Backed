package com.fjx.gathering.service;


import com.fjx.gathering.dao.GatheringDao;
        ...
        return new Specification<Gathering>() {
            ...
            public Predicate toPredicate(Root<Gathering> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                ...
                if (searchMap.get("name") != null && !"".equals(searchMap.get("name"))) {
                    predicateList.add(cb.like(root.get("name").as(String.class),
                ...
                // 城市
                if (searchMap.get("Spit") != null && !"".equals(searchMap.get("Spit"))) {
                    predicateList.add(cb.like(root.get("Spit").as(String.class), "%" + (String) searchMap.get("Spit") + "%"));
                }
